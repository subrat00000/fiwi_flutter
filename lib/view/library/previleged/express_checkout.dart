...
class ExpressCheckoutScreen extends StatefulWidget {
  ...
  @override
  State<ExpressCheckoutScreen> createState() => ExpressCheckoutScreenState();
}

class ExpressCheckoutScreenState extends State<ExpressCheckoutScreen> {
        ...
        child: Scaffold(
          ...
          icon: const Icon(Icons.arrow_back_ios_new_rounded,
              color: Colors.black87),
                          ...
                          'Express Book Checkout',style: TextStyle(color: Colors.black87,fontSize: 20),),),
